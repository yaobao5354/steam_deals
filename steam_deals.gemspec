...
Gem::Specification.new do |spec|
  spec.name          = "steam_deals"
  spec.version       = SteamDeals::VERSION
  spec.authors       = ["'yaoyu bao'"]
  spec.email         = ["'yaobao5354@gmail.com'"]

  spec.summary       = %q{finds steam deals}
  spec.description   = %q{find deals on the steam home page}
